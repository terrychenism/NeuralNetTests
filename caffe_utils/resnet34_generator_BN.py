...
def generate_train_val():
    ...
    '''stage 1'''
    last_top = 'pool1'
    network_str += generate_conv_layer(1, 64, 1, 0, 'conv1_output', last_top, 'conv1_output')
    network_str += generate_bn_layer('conv1_output_bn', 'conv1_output', 'conv1_output_bn')
    network_str += generate_activation_layer('conv1_output_relu', 'conv1_output_bn', 'conv1_output_bn', 'ReLU')
    last_output = 'conv1_output_bn'
    for l in xrange(1, args.layer_number[0]+1):
        network_str += generate_conv_layer(3, 64, 1, 1, 'conv2_%d_1'%l, last_top, 'conv2_%d_1'%l)
        ...
        network_str += generate_eltwise_layer('conv2_%d_sum'%l, last_output, 'conv2_%d_2_bn'%l, 'conv2_%d_sum'%l, 'SUM')
    ...
    network_str += generate_conv_layer(1, 128, 2, 0, 'conv2_output', last_top, 'conv2_output')
    network_str += generate_bn_layer('conv2_output_bn', 'conv2_output', 'conv2_output_bn')
    network_str += generate_activation_layer('conv2_output_relu', 'conv2_output_bn', 'conv2_output_bn', 'ReLU')
    last_output = 'conv2_output_bn'
    '''stage 2'''
    ...
    network_str += generate_eltwise_layer('conv3_1_sum', last_output, 'conv3_1_2_bn', 'conv3_1_sum', 'SUM')
    ...
    for l in xrange(2, args.layer_number[1]+1):
        network_str += generate_conv_layer(3, 128, 1, 1, 'conv3_%d_1'%l, last_top, 'conv3_%d_1'%l)
        ...
        network_str += generate_eltwise_layer('conv3_%d_sum'%l, last_top, 'conv3_%d_2_bn'%l, 'conv3_%d_sum'%l, 'SUM')
    ...
    network_str += generate_conv_layer(1, 256, 2, 0, 'conv3_output', last_top, 'conv3_output')
    network_str += generate_bn_layer('conv3_output_bn', 'conv3_output', 'conv3_output_bn')
    network_str += generate_activation_layer('conv3_output_relu', 'conv3_output_bn', 'conv3_output_bn', 'ReLU')
    last_output = 'conv3_output_bn'
    '''stage 3'''
    ...
    network_str += generate_eltwise_layer('conv4_1_sum', last_output, 'conv4_1_2_bn', 'conv4_1_sum', 'SUM')
    ...
    for l in xrange(2, args.layer_number[2]+1):
        network_str += generate_conv_layer(3, 256, 1, 1, 'conv4_%d_1'%l, last_top, 'conv4_%d_1'%l)
        ...
        network_str += generate_eltwise_layer('conv4_%d_sum'%l, last_top, 'conv4_%d_2_bn'%l, 'conv4_%d_sum'%l, 'SUM')
    ...
    network_str += generate_conv_layer(1, 512, 2, 0, 'conv4_output', last_top, 'conv4_output')
    network_str += generate_bn_layer('conv4_output_bn', 'conv4_output', 'conv4_output_bn')
    network_str += generate_activation_layer('conv4_output_relu', 'conv4_output_bn', 'conv4_output_bn', 'ReLU')
    last_output = 'conv4_output_bn'
    '''stage 4'''
    ...
    for l in xrange(2, args.layer_number[3]+1):
        network_str += generate_conv_layer(3, 512, 1, 1, 'conv5_%d_1'%l, last_top, 'conv5_%d_1'%l)
        ...
        network_str += generate_eltwise_layer('conv5_%d_sum'%l, last_top, 'conv5_%d_2_bn'%l, 'conv5_%d_sum'%l, 'SUM')
