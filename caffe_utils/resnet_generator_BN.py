...
def generate_train_val():
    ...
    for l in xrange(1, args.layer_number[0]+1):
        ...
        network_str += generate_bn_layer('conv2_%d_3_bn'%l, 'conv2_%d_3'%l, 'conv2_%d_3_bn'%l)
        network_str += generate_eltwise_layer('conv2_%d_sum'%l, last_output, 'conv2_%d_3_bn'%l, 'conv2_%d_sum'%l, 'SUM') 
    ...
    network_str += generate_bn_layer('conv3_1_3_bn', 'conv3_1_3', 'conv3_1_3_bn')
    network_str += generate_eltwise_layer('conv3_1_sum', last_output, 'conv3_1_3_bn', 'conv3_1_sum', 'SUM')
    ...
    for l in xrange(2, args.layer_number[1]+1):
        ...
        network_str += generate_bn_layer('conv3_%d_3_bn'%l, 'conv3_%d_3'%l, 'conv3_%d_3_bn'%l)
        network_str += generate_eltwise_layer('conv3_%d_sum'%l, last_top, 'conv3_%d_3_bn'%l, 'conv3_%d_sum'%l, 'SUM')
    ...
    network_str += generate_bn_layer('conv4_1_3_bn', 'conv4_1_3', 'conv4_1_3_bn')
    network_str += generate_eltwise_layer('conv4_1_sum', last_output, 'conv4_1_3_bn', 'conv4_1_sum', 'SUM')
    ...
    for l in xrange(2, args.layer_number[2]+1):
        ...
        network_str += generate_bn_layer('conv4_%d_3_bn'%l, 'conv4_%d_3'%l, 'conv4_%d_3_bn'%l)
        network_str += generate_eltwise_layer('conv4_%d_sum'%l, last_top, 'conv4_%d_3_bn'%l, 'conv4_%d_sum'%l, 'SUM')
    ...
    network_str += generate_bn_layer('conv5_1_3_bn', 'conv5_1_3', 'conv5_1_3_bn')
    network_str += generate_eltwise_layer('conv5_1_sum', last_output, 'conv5_1_3_bn', 'conv5_1_sum', 'SUM')
    ...
    for l in xrange(2, args.layer_number[3]+1):
        ...
        network_str += generate_bn_layer('conv5_%d_3_bn'%l, 'conv5_%d_3'%l, 'conv5_%d_3_bn'%l)
        network_str += generate_eltwise_layer('conv5_%d_sum'%l, last_top, 'conv5_%d_3_bn'%l, 'conv5_%d_sum'%l, 'SUM')
