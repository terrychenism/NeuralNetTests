...
TrnData = mnistData(1:TrnSize, 1:end)';
TrnLabels = mnistLabels(1:TrnSize,end);
ValData = mnistData(TrnSize+1:TrnSize+2000,1:end)';
ValLabel = mnistLabels(TrnSize+1:TrnSize+2000, end);
